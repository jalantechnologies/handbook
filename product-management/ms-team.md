...
**Tabs to Add:** Channel Guide, Figma, Onboarding Document, Confluence, Active Sprint Board, Credentials
...
**Tabs to Add:** Engineering Docs, GitHub
...
**Use Cases:** Submitting PRs for review with all necessary details to enable efficient and thorough evaluations. PR Review Requirements:
   ...
   3. Loom Video: Share a short [Loom](https://jalantechnology.sharepoint.com/:x:/s/Better9/EROdSUIn-_dDuWkgNjss1BUBBPqKLTd1gLpmgOZKp9f5qA?e=zLrsFE) video demonstrating the feature or changes in action.
...
**Use Cases:** Share QA notes and bug reports with Jira tickets, discuss bug fixes, and track issue resolutions
...
**Tabs to Add:** Sprint in Confluence
...
3. Configure Integrations: Set up production's monitoring tools and connect to the Alert Channel.
